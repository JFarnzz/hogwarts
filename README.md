...
- [W/// orking features](#working-features)
- [¿/// Why development is so slow?](#why-development-is-so-slow)
- [H/// otkeys](#hotkeys)
- [B/// roomstick hotkeys](#broomstick-hotkeys)
- [ToDo](#todo)
- [C/// redits](#credits)
...
Help me re-vitalize and modernize this branch of a game development that has been stale for a long time now. It will need to be adapted to work with shader graph (Unity 6000.4) and I hope to expand upon the functionality and features after doing so
