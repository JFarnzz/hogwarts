...
#pragma warning restore 414
        ...
        void OnEnable()
        {
            ...
            if (!(UnityEngine.Rendering.GraphicsSettings.defaultRenderPipeline is UnityEngine.Rendering.HighDefinition.HDRenderPipelineAsset))
            {
    ...
    public partial class OceanRenderer : IValidated
    {
        public static void RunValidation(OceanRenderer ocean)
        {
            ...
            var gerstners = FindObjectsByType<ShapeGerstnerBatched>(FindObjectsSortMode.None);
            ...
            // OceanDepthCache
            var depthCaches = FindObjectsByType<OceanDepthCache>(FindObjectsSortMode.None);
            ...
            // AssignLayer
            var assignLayers = FindObjectsByType<AssignLayer>(FindObjectsSortMode.None);
            ...
            // FloatingObjectBase
            var floatingObjects = FindObjectsByType<FloatingObjectBase>(FindObjectsSortMode.None);
            ...
            // Inputs
            var inputs = FindObjectsByType<RegisterLodDataInputBase>(FindObjectsSortMode.None);
            ...
            // WaterBody
            var waterBodies = FindObjectsByType<WaterBody>(FindObjectsSortMode.None);
        ...
        public bool Validate(OceanRenderer ocean, ValidatedHelper.ShowMessage showMessage)
        {
            ...
            if (_renderingLayerMask != UnityEngine.Rendering.HighDefinition.RenderingLayerMask.Everything)
            {
                // Check that light layers are enabled on pipeline asset.
                var pipelineAsset = (HDRenderPipelineAsset)GraphicsSettings.defaultRenderPipeline;
